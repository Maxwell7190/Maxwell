...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Date       26/01/2019 09:20:09
    Team       Maxwell
    Email      max_cf@yahoo.com
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Maxwell' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'Maxwell' + W +'/' + R +'Bot ' + W + '>> ')
